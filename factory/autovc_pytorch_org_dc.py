...
class Discriminator(nn.Module):
    ...
    def __init__(self, num_speaker=256):
        super(Discriminator, self).__init__()
        self.conv1 = nn.Conv1d(176, 88, 3)
        self.conv2 = nn.Conv1d(88, 44, 3)
        self.conv3 = nn.Conv1d(44, 22, 3)
...
class AutoVC_ORG_DC(nn.Module):
    """AutoVC_ORG network."""

    def __init__(self, dim_neck, dim_emb, dim_pre, freq):
        super(AutoVC_ORG_DC, self).__init__()
